  ...
  return (
    <main>
        <div className="flex justify-center items-center p-4 z-10">
            <div className=" p-6">
                <h2 className="text-stone-700 text-xl font-bold">Procurando um post?</h2>
                <p className="mt-1 text-sm">Nos dê mais informações:</p>
                <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    <div className="flex flex-col">
                        <label htmlFor="name" className="text-stone-600 text-sm font-medium">Titulo</label>
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="manufacturer" className="text-stone-600 text-sm font-medium">Criador</label>
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="date" className="text-stone-600 text-sm font-medium">Data do Post</label>
